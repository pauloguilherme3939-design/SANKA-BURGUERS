...
export const SANKA_BURGERS = [
  {
    ...
    cat: "artesanais",
    code: "SK-L01",
    desc: "Pão de hambúrguer de 20 cm, hambúrguer artesanal de 250 g, queijo prato, presunto, ovo, alface, tomate e maionese caseira.",
    price: 37.9,
    tags: "burger,cheese,egg",
    src: "/assets/burgers/x-americano-v3.webp",
  },
  {
    name: "X-Acebolado",
    cat: "artesanais",
