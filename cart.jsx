...
function CartProvider({ children, catalog = [] }) {
  ...
  useEffect(() => {
    const orderFlowOpen = drawerOpen || checkoutOpen;
    document.body.style.overflow = orderFlowOpen ? 'hidden' : '';
    document.body.classList.toggle('order-flow-open', orderFlowOpen);
    return () => {
        ...
        {count > 0 && (
          <>
            ...
            <div className="cart-foot">
              ...
              <button type="button" className="btn btn-primary btn-lg cart-cta" onClick={openCheckout}>
